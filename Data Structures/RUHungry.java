    ...
    public void deleteStockNode ( String ingredientName ) {
        ...
        else
        {
            while( front.getNextStockNode() != null )
            {
                ...
                {
                    front.setNextStockNode(front.getNextStockNode());
                }
            }
        }
    }
    ...
    public void updateStock (String ingredientName, int ingredientID, int stockAmountToAdd) {
        ...
        if( ingredientName == null )
        {
            if (findStockNode(ingredientID) != null )
                findStockNode(ingredientID).getIngredient().setStockLevel(stockAmountToAdd);
        }
        else if( ingredientID == -1 )
        {
            if( findStockNode(ingredientName) != null )
                findStockNode(ingredientName).getIngredient().setStockLevel(stockAmountToAdd);
        }
        else 
        {
            if( findStockNode(ingredientName) != null )
